...
COPY senpai-anime/pom.xml .
RUN mvn dependency:go-offline -B

COPY senpai-anime/src ./src
...
COPY senpai-anime/m3u8fetcher.js /app/m3u8fetcher.js
COPY senpai-anime/package.json /app/package.json
COPY senpai-anime/package-lock.json /app/package-lock.json
